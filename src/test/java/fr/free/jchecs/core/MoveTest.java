...
public final class MoveTest {
	...
	public void testEquals() {
		final Move mvt1 = new Move(BLACK_PAWN, Square.valueOf("a2"),
				Square.valueOf("a4"));
		final Move mvt2 = new Move(BLACK_PAWN, Square.valueOf(8),
				Square.valueOf(24));
		final Move mvt3 = new Move(BLACK_PAWN, Square.valueOf(8),
				Square.valueOf(16));
	...
	public void testHashCode() {
		...
		final Move mvt2 = new Move(BLACK_PAWN, Square.valueOf(8),
				Square.valueOf(24));
		final Move mvt3 = new Move(BLACK_PAWN, Square.valueOf(16),
				Square.valueOf(24));
	...
	public void testToId() {
		...
		final Move mvt2 = new Move(BLACK_PAWN, Square.valueOf(8),
				Square.valueOf(24));
		final Move mvt3 = new Move(BLACK_PAWN, Square.valueOf("a2"),
				Square.valueOf("b1"), WHITE_PAWN);
		final Move mvt4 = new Move(BLACK_PAWN, Square.valueOf("a2"),
				Square.valueOf("b1"), WHITE_BISHOP, BLACK_KNIGHT);
		...
		assertTrue(mvt3.toId() != mvt4.toId());
	}
	...
	public void testToString() {
		final Move mvt = new Move(WHITE_BISHOP, Square.valueOf("a3"),
				Square.valueOf("d6"), BLACK_PAWN);
		final String attendu = "Move[piece=WHITE_BISHOP,from=Square[file=a,rank=3],"
				+ "to=Square[file=d,rank=6],captured=BLACK_PAWN,promotion=null]";
