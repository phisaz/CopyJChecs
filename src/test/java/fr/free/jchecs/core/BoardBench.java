...
/**
 * Classe utilitaire permettant de tester les performances des classes
 * représentant des états de la partie.
 *
 * @author David Cotton
 */
final class BoardBench {
    /**
    ...
    public static void main(final String[] pArgs) {
        ...
        System.out.println("Benchmark (" + 64 * nbTests * 5
                + ") : getPieceAt(Square)");
