...
public final class FENUtilsTest {
	...
	public void testToBoard() {
		...
		try {
			assertEquals(toBoard(STANDART_STARTING_FEN),
					BoardFactory.valueOf(ARRAY, STARTING));
	...
	public void testToFEN() {
		...
		assertEquals(toFEN(BoardFactory.valueOf(ARRAY, STARTING)),
				STANDART_STARTING_FEN);
	}
