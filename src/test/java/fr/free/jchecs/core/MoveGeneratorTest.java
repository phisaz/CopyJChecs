...
public final class MoveGeneratorTest {
     ...
     */
    private static void sameMoves(final String pNom, final Move[] pListe1,
                                  final Move[] pListe2) {
    ...
    public void testDerive() {
        final Piece[] dispositionFinale = {WHITE_ROOK, WHITE_KNIGHT,
                WHITE_BISHOP, null, WHITE_KING, null, WHITE_KNIGHT, WHITE_ROOK,
                WHITE_PAWN, WHITE_PAWN, WHITE_PAWN, WHITE_PAWN, null,
                WHITE_PAWN, WHITE_PAWN, WHITE_PAWN, null, null, null, null,
                WHITE_PAWN, null, null, null, null, null, WHITE_BISHOP, null,
                null, null, null, null, null, null, null, null, null, null,
                null, null, null, BLACK_PAWN, null, null, null, null, null,
                BLACK_KNIGHT, BLACK_PAWN, BLACK_BISHOP, BLACK_PAWN, BLACK_PAWN,
                BLACK_PAWN, WHITE_QUEEN, BLACK_PAWN, BLACK_PAWN, BLACK_ROOK,
                BLACK_KNIGHT, null, BLACK_QUEEN, BLACK_KING, BLACK_BISHOP,
                null, BLACK_ROOK,};
        for (final BoardFactory.Type t : BoardFactory.Type.values()) {
            MoveGenerator etat = BoardFactory.valueOf(t,
                    BoardFactory.State.STARTING);
            final String nomClasse = etat.getClass().getSimpleName();
            etat = etat.derive(new Move(WHITE_PAWN, Square.valueOf("e2"),
                    Square.valueOf("e3")), true);
            etat = etat.derive(new Move(BLACK_PAWN, Square.valueOf("b7"),
                    Square.valueOf("b6")), true);
            etat = etat.derive(new Move(WHITE_BISHOP, Square.valueOf("f1"),
                    Square.valueOf("c4")), true);
            etat = etat.derive(new Move(BLACK_KNIGHT, Square.valueOf("g8"),
                    Square.valueOf("h6")), true);
            etat = etat.derive(new Move(WHITE_QUEEN, Square.valueOf("d1"),
                    Square.valueOf("f3")), true);
            etat = etat.derive(new Move(BLACK_BISHOP, Square.valueOf("c8"),
                    Square.valueOf("b7")), true);
            assertTrue(nomClasse, etat.isWhiteActive());
            assertTrue(nomClasse, etat.getHalfmoveCount() == 4);
            etat = etat.derive(new Move(WHITE_QUEEN, Square.valueOf("f3"),
                    Square.valueOf("f7"), BLACK_PAWN), true);
            ...
            for (final Square s : Square.values()) {
                assertSame(nomClasse, etat.getPieceAt(s),
                        dispositionFinale[s.getIndex()]);
            }
        }
    }

    /**
     * Teste l'équivalence des méthodes de recherche des cases cibles d'une
     * position.
     */
    @Test
    public void testGetAllTargets() {
        MoveGenerator etatPrec1 = null;
        MoveGenerator etatPrec2 = null;
        for (final BoardFactory.Type t : BoardFactory.Type.values()) {
            final MoveGenerator etat1 = BoardFactory.valueOf(t,
                    BoardFactory.State.STARTING);
            MoveGenerator etat2 = etat1;
            try {
                etat2 = etat2.derive(FENUtils
                        .toBoard("8/k7/8/8/8/8/1p6/7K b - - 10 10"));
            } catch (final FENException e) {
                fail(e.toString());
            }
            if ((etatPrec1 != null) && (etatPrec2 != null)) {
                final String nomClasse = etat1.getClass().getSimpleName();
                for (final Square s : Square.values()) {
                    sameSquares(nomClasse, etatPrec1.getAllTargets(s),
                            etat1.getAllTargets(s));
                    sameSquares(nomClasse, etatPrec2.getAllTargets(s),
                            etat2.getAllTargets(s));
                }
            }
            etatPrec1 = etat1;
            etatPrec2 = etat2;
    ...
    public void testGetBishopTargets() {
        ...
        for (final BoardFactory.Type t : BoardFactory.Type.values()) {
            ...
            if (ePrec != null) {
                final String nomClasse = etat.getClass().getSimpleName();
                for (final Square s : Square.values()) {
                    sameSquares(nomClasse, ePrec.getBishopTargets(s, true),
                            etat.getBishopTargets(s, true));
                    sameSquares(nomClasse, ePrec.getBishopTargets(s, false),
    ...
    public void testGetKingSquare() {
        ...
        for (final BoardFactory.Type t : BoardFactory.Type.values()) {
            ...
            if (etatPrec != null) {
                final String nomClasse = etat.getClass().getSimpleName();
                assertSame(nomClasse, etatPrec.getKingSquare(true),
                        etat.getKingSquare(true));
                assertSame(nomClasse, etatPrec.getKingSquare(false),
    ...
    public void testGetKingTargets() {
        ...
        for (final BoardFactory.Type t : BoardFactory.Type.values()) {
            ...
            if (etatPrec != null) {
                final String nomClasse = etat.getClass().getSimpleName();
                for (final Square s : Square.values()) {
                    sameSquares(nomClasse, etatPrec.getKingTargets(s, true),
                            etat.getKingTargets(s, true));
                    sameSquares(nomClasse, etatPrec.getKingTargets(s, false),
    ...
    /**
     * Teste l'équivalence des méthodes de recherche des cases cibles de
     * cavalier.
     */
    @Test
    public void testGetKnightTargets() {
        ...
        for (final BoardFactory.Type t : BoardFactory.Type.values()) {
            ...
            if (ePrec != null) {
                final String nomClasse = etat.getClass().getSimpleName();
                for (final Square s : Square.values()) {
                    sameSquares(nomClasse, ePrec.getKnightTargets(s, true),
                            etat.getKnightTargets(s, true));
                    sameSquares(nomClasse, ePrec.getKnightTargets(s, false),
    ...
    public void testGetPawnTargets() {
        ...
        for (final BoardFactory.Type t : BoardFactory.Type.values()) {
            ...
            if (etatPrec != null) {
                final String nomClasse = etat.getClass().getSimpleName();
                for (final Square s : Square.values()) {
                    sameSquares(nomClasse, etatPrec.getPawnTargets(s, true),
                            etat.getPawnTargets(s, true));
                    sameSquares(nomClasse, etatPrec.getPawnTargets(s, false),
    ...
    public void testGetQueenTargets() {
        ...
        for (final BoardFactory.Type t : BoardFactory.Type.values()) {
            ...
            if (ePrec != null) {
                final String nomClasse = etat.getClass().getSimpleName();
                for (final Square s : Square.values()) {
                    sameSquares(nomClasse, ePrec.getQueenTargets(s, true),
                            etat.getQueenTargets(s, true));
                    sameSquares(nomClasse, ePrec.getQueenTargets(s, false),
    ...
    public void testGetRookTargets() {
        ...
        for (final BoardFactory.Type t : BoardFactory.Type.values()) {
            ...
            if (etatPrec != null) {
                final String nomClasse = etat.getClass().getSimpleName();
                for (final Square s : Square.values()) {
                    sameSquares(nomClasse, etatPrec.getRookTargets(s, true),
                            etat.getRookTargets(s, true));
                    sameSquares(nomClasse, etatPrec.getRookTargets(s, false),
    ...
    /**
     * Teste l'équivalence des méthodes de recherche des cases mouvements
     * valides.
     */
    @Test
    public void testGetValidMoves() {
        final Move[] attendu = {
                ...
                new Move(WHITE_KNIGHT, Square.valueOf("b1"),
                        Square.valueOf("a3")),
                new Move(WHITE_KNIGHT, Square.valueOf("b1"),
                        Square.valueOf("c3")),
                new Move(WHITE_KNIGHT, Square.valueOf("g1"),
                        Square.valueOf("f3")),
                new Move(WHITE_KNIGHT, Square.valueOf("g1"),
                        Square.valueOf("h3")),};
        MoveGenerator etatPrec = null;
        for (final BoardFactory.Type t : BoardFactory.Type.values()) {
            ...
            if (etatPrec != null) {
                final String nomClasse = etat.getClass().getSimpleName();
                sameMoves(nomClasse, etatPrec.getValidMoves(true),
                        etat.getValidMoves(true));
                sameMoves(nomClasse, etatPrec.getValidMoves(false),
    ...
    /**
     * Teste l'équivalence des méthodes de recherche des cases cibles valides à
    ...
    public void testGetValidTargets() {
        ...
        for (final BoardFactory.Type t : BoardFactory.Type.values()) {
            ...
            if (etatPrec != null) {
                final String nomClasse = etat.getClass().getSimpleName();
                for (final Square s : Square.values()) {
                    sameSquares(nomClasse, etatPrec.getValidTargets(s),
                            etat.getValidTargets(s));
                }
                assertTrue(
                        nomClasse,
                        etatPrec.getValidTargets(Square.valueOf("a1")).length == 0);
                assertTrue(
                        nomClasse,
                        etatPrec.getValidTargets(Square.valueOf("b1")).length == 2);
                assertTrue(
                        nomClasse,
                        etatPrec.getValidTargets(Square.valueOf("b2")).length == 2);
            }
            etatPrec = etat;
        }
    }
    ...
    public void testIsAttacked() {
        ...
        for (final BoardFactory.Type t : BoardFactory.Type.values()) {
            ...
            if (etatPrec != null) {
                final String nomClasse = etat.getClass().getSimpleName();
                for (final Square s : Square.values()) {
                    assertTrue(nomClasse,
                            etatPrec.isAttacked(s, true) == etat.isAttacked(s,
                                    true));
                    assertTrue(nomClasse,
                            etatPrec.isAttacked(s, false) == etat.isAttacked(s,
                                    false));
                }
            }
            etatPrec = etat;
    ...
    public void testIsCastled() {
        ...
        for (final BoardFactory.Type t : BoardFactory.Type.values()) {
            ...
            if (etatPrec != null) {
                final String nomClasse = etat.getClass().getSimpleName();
                assertTrue(nomClasse,
                        etatPrec.isCastled(true) == etat.isCastled(true));
                assertTrue(nomClasse,
                        etatPrec.isCastled(false) == etat.isCastled(false));
            }
            etatPrec = etat;
        }
    }
    ...
    public void testPlaying() {
        ...
        for (int p = 100; p >= 0; p--) {
            for (final BoardFactory.Type t : BoardFactory.Type.values()) {
                etats[t.ordinal()] = BoardFactory.valueOf(t,
                        BoardFactory.State.STARTING);
            }
            for (int cps = 100; cps >= 0; cps--) {
                for (int i = 0; i < eLength; i++) {
                    ...
                    if (i > 0) {
                        sameMoves(etats[i].getClass().getSimpleName(),
                                mvts[i - 1], mvts[i]);
                    }
                }
                ...
                for (int i = 0; i < eLength; i++) {
                    ...
                    if (etats[i].isCastled(true)) {
                        assertFalse(etats[i].getClass().getSimpleName(),
                                etats[i].canCastleLong(true));
                        assertFalse(etats[i].getClass().getSimpleName(),
                                etats[i].canCastleShort(true));
                    }
                    if (etats[i].isCastled(false)) {
                        assertFalse(etats[i].getClass().getSimpleName(),
                                etats[i].canCastleLong(false));
                        assertFalse(etats[i].getClass().getSimpleName(),
                                etats[i].canCastleShort(false));
                    }
                    if (i > 0) {
                        assertEquals(etats[i].getClass().getSimpleName(),
                                etats[i - 1], etats[i]);
                        assertTrue(etats[i].getClass().getSimpleName(),
                                etats[i - 1].isCastled(true) == etats[i]
                                        .isCastled(true));
                        assertTrue(etats[i].getClass().getSimpleName(),
                                etats[i - 1].isCastled(false) == etats[i]
                                        .isCastled(false));
                    }
                }
            }
    ...
    private static final class PlayingThread extends Thread {
        ...
        public void run() {
            final Random randomizer = new Random(1000);
            MoveGenerator etat = BoardFactory.valueOf(_type,
                    BoardFactory.State.STARTING);
