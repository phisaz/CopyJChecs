...
/**
 * Signale une erreur dans une description de partie au format PGN.
 * <p>
 ...
 * @author David Cotton
 */
public final class PGNException extends Exception {
	/** Identifiant de la classe pour la sérialisation. */
	private static final long serialVersionUID = 4163290428464517795L;
	 ...
	 */
	PGNException(final String pMessage, final Throwable pErreur) {
