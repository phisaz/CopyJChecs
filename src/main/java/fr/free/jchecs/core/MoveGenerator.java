...
public interface MoveGenerator extends Board {
	 ...
	 * 
	 * @param pMouvement
	 *            Description de mouvement.
	 * @param pSuivant
	 *            Drapeau positionné si l'on souhaite que le trait soit modifié.
	 ...
	 *            Case à l'origine du mouvement.
	 * @param pBlanc
	 *            Positionné à vrai si la recherche concerne les blancs.
	 * @return Liste des cases cibles (y compris celles conduisant à un échec).
	 */
	 ...
	 * 
	 * @param pCouleur
	 *            Mis à "true" si l'on recherche le roi blanc, à "false" sinon.
	 ...
	 *            Case à l'origine du mouvement.
	 * @param pBlanc
	 *            A vrai pour indiquer une recherche sur les blancs.
	 * @return Liste des cases cibles (y compris celles conduisant à un échec).
	 */
	 ...
	 *            Case à l'origine du mouvement.
	 * @param pBlanc
	 *            Mis à vrai pour rechercher pour les blancs.
	 * @return Liste des cases cibles (y compris celles conduisant à un échec).
	 */
	 ...
	 * 
	 * @param pTrait
	 *            Positionné à "true" pour indiquer une recherche pour les
	 *            blancs.
	 ...
	 *            Case cible.
	 * @param pCouleur
	 *            Positionné à "true" pour tester l'attaque par les blancs.
	 ...
	 * 
	 * @param pCouleur
	 *            Positionné à "true" pour tester l'échec sur les blancs, à
	 *            "false" sinon.
